...
# ============================================================
# V8.8 — DASHBOARD COM GESTÃO DE PRAZOS E TABELA EM NEGRITO
# ============================================================
# CONFIGURAÇÃO
# ============================================================
...
// LÓGICA DE DETECÇÃO DE ATRASO (V8.8)
const hoje = new Date();
...
function verificarEmarcarAtrasos() {{
    rows.forEach(r => {{
        ...
        // Ordens já liberadas não contam como atrasadas em produção
        if (prazoTxt && status !== "LIBERADO") {{
            const partes = prazoTxt.split('/');
            if (partes.length === 3) {{
...
def processar():
    print("=" * 80)
    print("PROCESSAMENTO V8.8: TABELA TOTALMENTE EM NEGRITO")
    print("=" * 80)
