...
# ============================================================
# SIAP V8.8 — DASHBOARD COM FILTRO DE DATAS (DE / ATÉ)
# ============================================================
# CONFIGURAÇÃO
# ============================================================
...
<!-- FILTRO POR DATA INICIAL E FINAL (V8.8) -->
...
function applyFilters() {{
    ...
    rows.forEach(r => {{
        ...
        // Lógica da Data De / Até
        let passaData = true;
        if (valIni || valFin) {{
            if (!dtPrazo) {{
                passaData = false; // Se tiver filtro de data ativo e a linha não tiver data válida
            }} else {{
...
def processar():
    print("=" * 80)
    print("PROCESSAMENTO SIAP V8.8: COM FILTRO DE DATAS (DE / ATÉ)")
    print("=" * 80)
